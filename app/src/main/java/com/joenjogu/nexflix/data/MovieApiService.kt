...
interface MoviesApiService {
    @GET("movie/{movie_id}")
    suspend fun getMovie(@Path("movie_id") movieId: Int, @Query("api_key") apiKey: String): MovieResult

    @GET("movie/top_rated")
    suspend fun getTopMovies(@Query("api_key") apiKey: String): SearchResponse
